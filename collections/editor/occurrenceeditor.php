...
<head>
    ...
    if ($crowdSourceMode == 1) {
        ?>
        <link
            href="includes/config/occureditorcrowdsource.css?ver=1805"
            type="text/css" rel="stylesheet" id="editorCssLink"
        />
        <?php
    }
    else {
        ?>
        <link
            href="../../css/occureditor.css?ver=170604" type="text/css"
            rel="stylesheet" id="editorCssLink"
        />
        <?php
        if (isset($CSSARR)) {
    ...
    <script
        src="../../js/jquery-ui.js?ver=140310"
        type="text/javascript"
    ></script>
    <script
        src="../../js/jquery.imagetool-1.7.js?ver=140310"
        type="text/javascript"
    ></script>
    ...
    <script
        type="text/javascript"
        src="../../js/symb/collections.coordinateValidation.js?ver=170310"
    ></script>
    <script
        type="text/javascript"
        src="../../js/symb/collections.occureditormain.js?ver=20170503"
    ></script>
    <script
        type="text/javascript"
        src="../../js/symb/collections.occureditortools.js?ver=170104"
    ></script>
    <script
        type="text/javascript"
        src="../../js/symb/collections.occureditorimgtools.js?ver=170310"
    ></script>
    <script
        type="text/javascript"
        src="../../js/symb/collections.occureditorshare.js?ver=171127"
    ></script>
</head>
<body>
<!-- inner text -->
    ...
    if ($occId || $crowdSourceMode || ($isEditor && $collId)) {
        ...
        <div id="navDiv">
            ...
            if (isset($collections_editor_occurrenceeditorCrumbs)) {
                ...
                <div class='navpath'>
                    <a
                        href="../../index.php"
                        onclick="return verifyLeaveForm()"
                    >Home</a> &gt;&gt;
                    <?php
                    if ($crowdSourceMode) {
                        ?>
                        <a href="../specprocessor/crowdsource/index.php">Crowd
                            Sourcing Central</a> &gt;&gt;
                        <?php
                    }
                    else {
                        if ($isGenObs) {
                            ?>
                            <a
                                href="../../profile/viewprofile.php?tabindex=1"
                                onclick="return verifyLeaveForm()"
                            >Personal
                                Management</a> &gt;&gt;
                            <?php
                            ...
                            if ($isEditor == 1 || $isEditor == 2) {
                                ?>
                                <a
                                    href="../misc/collprofiles.php?collid=<?php echo $collId; ?>&emode=1"
                                    onclick="return verifyLeaveForm()"
                                >Collection
                                    Management</a> &gt;&gt;
                                <?php
        ...
        if ($statusStr) {
            ...
            <div id="statusdiv" style="margin:5px 0px 5px 15px;">
                <b>Action Status: </b>
                <span
                    style="color:<?php echo(stripos($statusStr, 'ERROR') !== false ? 'red' : 'green'); ?>;"
                ><?php echo $statusStr; ?></span>
                <?php
                if ($action == 'Delete Occurrence') {
                    ?>
                    <br/>
        ...
        if ($occArr || $goToMode == 1 || $goToMode == 2) {    //$action == 'gotonew'
            if ($occId && $isLocked) {
                ?>
                <div
                    style="margin:25px;border:2px double;padding:20px;width:90%;"
                >
                    <div style="color:red;font-weight:bold;font-size:110%;">
                        Record Locked!
                    </div>
                    <div>
                        This record is locked for editing by another user. Once
                        the
                        user is done with the record, the lock will be removed.
                        Records are locked for a maximum of 15 minutes.
                    </div>
                    <div style="margin:20px;font-weight:bold;">
                        <a
                            href="../individual/index.php?occid=<?php echo $occId; ?>"
                            target="_blank"
                        >Read-only Display</a>
                    </div>
                </div>
                ...
                <table id="edittable" style="">
                    <tr>
                        <td id="editortd" style="" valign="top">
                            <div id="occedittabs" style="clear:both;">
                                <ul>
                                    ...
                                    if ($occId && $isEditor) {
                                        ...
                                        <li id="detTab">
                                            <a
                                                href="includes/determinationtab.php?<?php echo $anchorVars . '&' . $detVars; ?>"
                                                style=""
                                            >Determination
                                                History</a>
                                        </li>
                                        ...
                                        if ($isEditor == 1 || $isEditor == 2) {
                                            ...
                                            <li id="imgTab">
                                                <a
                                                    href="includes/imagetab.php?<?php echo $anchorVars; ?>"
                                                    style=""
                                                >Images</a>
                                            </li>
                                            <li id="resourceTab">
                                                <a
                                                    href="includes/resourcetab.php?<?php echo $anchorVars; ?>"
                                                    style=""
                                                >Linked
                                                    Resources</a>
                                            </li>
                                            <li id="adminTab">
                                                <a
                                                    href="includes/admintab.php?<?php echo $anchorVars; ?>"
                                                    style=""
                                                >Admin</a>
                                            </li>
                                            <?php
                                ...
                                <div id="occdiv">
                                    <form
                                        id="fullform" name="fullform"
                                        action="occurrenceeditor.php"
                                        method="post"
                                        onsubmit="return verifyFullForm(this);"
                                    >
                                        <fieldset>
                                            <legend><b>Collector Info</b>
                                            </legend>
                                            <?php
                                            if ($occId) {
                                                if ($fragArr || $specImgArr) {
                                                    ?>
                                                    <div
                                                        style="float:right;margin:-7px -4px 0px 0px;font-weight:bold;"
                                                    >
														<span
                                                            id="imgProcOnSpan"
                                                            style="display:block;"
                                                        >
															<a
                                                                href="#"
                                                                onclick="toggleImageTdOn();return false;"
                                                            >&gt;&gt;</a>
														</span>
                                                        <span
                                                            id="imgProcOffSpan"
                                                        ...
                                                        >
															<a
                                                                href="#"
                                                                onclick="toggleImageTdOff();return false;"
                                                            >&lt;&lt;</a>
														</span>
                                                    </div>
                                                    <?php
                                                ...
                                                if ($crowdSourceMode) {
                                                    ?>
                                                    <div
                                                        style="float:right;margin:-7px 10px 0px 0px;font-weight:bold;"
                                                    >
                                      <span
                                          id="longtagspan"
                                          style="cursor:pointer;"
                                          onclick="toggleCsMode(0);return false;"
                                      >Long Form</span>
                                                        <span
                                                            id="shorttagspan"
                                                            style="cursor:pointer;display:none;"
                                                            onclick="toggleCsMode(1);return false;"
                                                        >Short Form</span>
                                                    </div>
                                                    <?php
                                                }
                                            ...
                                            <div style="clear:both;">
                                                <div id="catalogNumberDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('catalogNumber')"
                                                    ><img
                                                            class="docimg"
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="2"
                                                        maxlength="32"
                                                        value="<?php echo array_key_exists('catalognumber', $occArr) ? $occArr['catalognumber'] : ''; ?>"
                                                        onchange="fieldChanged('catalognumber');<?php if (!defined('CATNUMDUPECHECK') || CATNUMDUPECHECK) echo 'searchDupesCatalogNumber(this.form,true)'; ?>" <?php if (!$isEditor || $isEditor == 3) echo 'disabled'; ?>
                                                        autocomplete="off"
                                                    />
                                                </div>
                                                <div
                                                    id="otherCatalogNumbersDiv"
                                                >
                                                    <?php echo(defined('OTHERCATALOGNUMBERSLABEL') ? OTHERCATALOGNUMBERSLABEL : 'Other Cat. #s'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('otherCatalogNumbers')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="4"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('othercatalognumbers', $occArr) ? $occArr['othercatalognumbers'] : ''; ?>"
                                                        onchange="fieldChanged('othercatalognumbers');<?php if (!defined('OTHERCATNUMDUPECHECK') || OTHERCATNUMDUPECHECK) echo 'searchDupesOtherCatalogNumbers(this.form)'; ?>"
                                                        autocomplete="off"
                                                    />
                                                </div>
                                                <div id="recordedByDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('recordedBy')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="6"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('recordedby', $occArr) ? $occArr['recordedby'] : ''; ?>"
                                                        onchange="fieldChanged('recordedby');"
                                                    />
                                                </div>
                                                <div id="recordNumberDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('recordNumber')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="8"
                                                        maxlength="45"
                                                        value="<?php echo array_key_exists('recordnumber', $occArr) ? $occArr['recordnumber'] : ''; ?>"
                                                        onchange="recordNumberChanged(this);"
                                                    />
                                                </div>
                                                <div
                                                    id="eventDateDiv"
                                                    title="Earliest Date Collected"
                                                >
                                                    <?php echo(defined('EVENTDATELABEL') ? EVENTDATELABEL : 'Date'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('eventDate')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        name="eventdate"
                                                        tabindex="10"
                                                        value="<?php echo array_key_exists('eventdate', $occArr) ? $occArr['eventdate'] : ''; ?>"
                                                        onchange="eventDateChanged(this);"
                                                    />
                                                </div>
                                                <?php
                                                if (!defined('DUPESEARCH') || DUPESEARCH) {
                                                    ...
                                                    <div id="dupesDiv">
                                                        <input
                                                            ...
                                                            value="Dupes?"
                                                            tabindex="12"
                                                            onclick="searchDupes(this.form);"
                                                        /><br/>
                                                        <input
                                                            type="checkbox"
                                                            name="autodupe"
                                                            value="1"
                                                            onchange="autoDupeChanged(this)"
                                                        />
                                                        Auto search
                                                    </div>
                                                    <?php
                                            ...
                                            <div style="clear:both;">
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="14"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('associatedcollectors', $occArr) ? $occArr['associatedcollectors'] : ''; ?>"
                                                        onchange="fieldChanged('associatedcollectors');"
                                                    />
                                                </div>
                                                <div id="verbatimEventDateDiv">
                                                    <div class="flabel">
                                                        ...
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('verbatimEventDate')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="19"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('verbatimeventdate', $occArr) ? $occArr['verbatimeventdate'] : ''; ?>"
                                                    />
                                                </div>
                                                <div id="dateToggleDiv">
                                                    <a
                                                        href="#"
                                                        onclick="toggle('dateextradiv');return false;"
                                                    ><img
                                                            src="../../images/editplus.png"
                                                            style="width:15px;"
                                                        /></a>
                                                </div>
                                                <?php
                                                if (array_key_exists('loan', $occArr)) {
                                                    ?>
                                                    <fieldset
                                                        style="float:right;margin:3px;border:1px solid red;"
                                                    >
                                                        <legend
                                                        ...
                                                        <b>To:</b> <a
                                                            href="../loans/index.php?loantype=out&collid=<?php echo $collId . '&loanid=' . $occArr['loan']['id']; ?>"
                                                        >
                                                            <?php echo $occArr['loan']['code']; ?></a><br/>
                                                        <b>Due
                                                            date:</b> <?php echo(isset($occArr['loan']['date']) ? $occArr['loan']['date'] : 'Not Defined'); ?>
                                                    </fieldset>
                                                    <?php
                                                }
                                                ?>
                                            ...
                                            <div id="dateextradiv">
                                                <div id="ymdDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        name="year"
                                                        tabindex="20"
                                                        value="<?php echo array_key_exists('year', $occArr) ? $occArr['year'] : ''; ?>"
                                                        onchange="inputIsNumeric(this, 'Year');fieldChanged('year');"
                                                        title="Numeric Year"
                                                    />-
                                                    <input
                                                        type="text"
                                                        name="month"
                                                        tabindex="21"
                                                        value="<?php echo array_key_exists('month', $occArr) ? $occArr['month'] : ''; ?>"
                                                        onchange="inputIsNumeric(this, 'Month');fieldChanged('month');"
                                                        title="Numeric Month"
                                                    />-
                                                    <input
                                                        type="text"
                                                        name="day"
                                                        tabindex="22"
                                                        value="<?php echo array_key_exists('day', $occArr) ? $occArr['day'] : ''; ?>"
                                                        onchange="inputIsNumeric(this, 'Day');fieldChanged('day');"
                                                        title="Numeric Day"
                                                    />
                                                </div>
                                                <div id="dayOfYearDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('startDayOfYear')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    <input
                                                        ...
                                                        name="startdayofyear"
                                                        tabindex="24"
                                                        value="<?php echo array_key_exists('startdayofyear', $occArr) ? $occArr['startdayofyear'] : ''; ?>"
                                                        onchange="inputIsNumeric(this, 'Start Day of Year');fieldChanged('startdayofyear');"
                                                    ...
                                                    <input
                                                        ...
                                                        name="enddayofyear"
                                                        tabindex="26"
                                                        value="<?php echo array_key_exists('enddayofyear', $occArr) ? $occArr['enddayofyear'] : ''; ?>"
                                                        onchange="inputIsNumeric(this, 'End Day of Year');fieldChanged('enddayofyear');"
                                                ...
                                                <div id="exsDiv">
                                                    <div id="ometidDiv">
                                                        ...
                                                        <input
                                                            id="exstitleinput"
                                                            name="exstitle"
                                                            value="<?php echo(isset($occArr['exstitle']) ? $occArr['exstitle'] : ''); ?>"
                                                        />
                                                        <input
                                                            id="ometidinput"
                                                            name="ometid"
                                                            type="text"
                                                            style="display: none;"
                                                            value="<?php echo(isset($occArr['ometid']) ? $occArr['ometid'] : ''); ?>"
                                                            onchange="fieldChanged('ometid')"
                                                        />
                                                    </div>
                                                    <div id="exsnumberDiv">
                                                        Number<br/>
                                                        <input
                                                            name="exsnumber"
                                                            type="text"
                                                            value="<?php echo isset($occArr['exsnumber']) ? $occArr['exsnumber'] : ''; ?>"
                                                            onchange="fieldChanged('exsnumber')"
                                                        />
                                                    </div>
                                                </div>
                                                <?php
                                        ...
                                        <fieldset>
                                            <legend><b>Latest Identification</b>
                                            </legend>
                                            <div style="clear:both;">
                                                <div id="scinameDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('scientificName')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        maxlength="250"
                                                        tabindex="28"
                                                        value="<?php echo array_key_exists('sciname', $occArr) ? $occArr['sciname'] : ''; ?>"
                                                        onchange="fieldChanged('sciname');" <?php if (!$isEditor || $isEditor == 3) echo 'disabled '; ?> />
                                                    <input
                                                        type="hidden"
                                                        id="tidinterpreted"
                                                        name="tidinterpreted"
                                                        value="<?php echo array_key_exists('tidinterpreted', $occArr) ? $occArr['tidinterpreted'] : ''; ?>"
                                                    />
                                                    <?php
                                                    if (!$isEditor) {
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        ...
                                                        maxlength="100"
                                                        tabindex="0"
                                                        value="<?php echo array_key_exists('scientificnameauthorship', $occArr) ? $occArr['scientificnameauthorship'] : ''; ?>"
                                                        onchange="fieldChanged('scientificnameauthorship');" <?php if (!$isEditor || $isEditor == 3) echo 'disabled'; ?> />
                                                </div>
                                            </div>
                                            <div
                                                style="clear:both;padding:3px 0px 0px 10px;"
                                            >
                                                <?php
                                                if (!$occId) {
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="30"
                                                        size="25"
                                                        value="<?php echo array_key_exists('identificationqualifier', $occArr) ? $occArr['identificationqualifier'] : ''; ?>"
                                                        onchange="fieldChanged('identificationqualifier');" <?php if (!$isEditor || $isEditor == 3) echo 'disabled'; ?> />
                                                </div>
                                                <div id="familyDiv">
                                                    <?php echo(defined('FAMILYLABEL') ? FAMILYLABEL : 'Family'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('family')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    <input
                                                        ...
                                                        maxlength="50"
                                                        tabindex="0"
                                                        value="<?php echo array_key_exists('family', $occArr) ? $occArr['family'] : ''; ?>"
                                                        onchange="fieldChanged('family');"
                                                    />
                                                </div>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <div id="identifiedByDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('identifiedBy')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    <input
                                                        ...
                                                        maxlength="255"
                                                        tabindex="32"
                                                        value="<?php echo array_key_exists('identifiedby', $occArr) ? $occArr['identifiedby'] : ''; ?>"
                                                        onchange="fieldChanged('identifiedby');"
                                                    />
                                                </div>
                                                <div id="dateIdentifiedDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('dateIdentified')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    <input
                                                        ...
                                                        maxlength="45"
                                                        tabindex="34"
                                                        value="<?php echo array_key_exists('dateidentified', $occArr) ? $occArr['dateidentified'] : ''; ?>"
                                                        onchange="fieldChanged('dateidentified');"
                                                    />
                                                </div>
                                                <div
                                                    id="idrefToggleDiv"
                                                    onclick="toggle('idrefdiv');"
                                                >
                                                    <img
                                                        src="../../images/editplus.png"
                                                        style="width:15px;"
                                            ...
                                            <div id="idrefdiv">
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="36"
                                                        value="<?php echo array_key_exists('identificationreferences', $occArr) ? $occArr['identificationreferences'] : ''; ?>"
                                                        onchange="fieldChanged('identificationreferences');"
                                                    />
                                                </div>
                                                <div
                                                    id="identificationRemarksDiv"
                                                >
                                                    <?php echo(defined('IDENTIFICATIONREMARKSLABEL') ? IDENTIFICATIONREMARKSLABEL : 'ID Remarks'); ?>
                                                    :
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('identificationRemarks')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    <input
                                                        ...
                                                        tabindex="38"
                                                        value="<?php echo array_key_exists('identificationremarks', $occArr) ? $occArr['identificationremarks'] : ''; ?>"
                                                        onchange="fieldChanged('identificationremarks');"
                                                    />
                                                </div>
                                                <div id="taxonRemarksDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('taxonRemarks')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    <input
                                                        ...
                                                        name="taxonremarks"
                                                        tabindex="39"
                                                        value="<?php echo array_key_exists('taxonremarks', $occArr) ? $occArr['taxonremarks'] : ''; ?>"
                                                        onchange="fieldChanged('taxonremarks');"
                                                    />
                                                </div>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            ...
                                            <div style="clear:both;">
                                                <div id="countryDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        name="country"
                                                        tabindex="40"
                                                        value="<?php echo array_key_exists('country', $occArr) ? $occArr['country'] : ''; ?>"
                                                        onchange="fieldChanged('country');"
                                                        autocomplete="off"
                                                    />
                                                </div>
                                                <div id="stateProvinceDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('stateProvince')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        name="stateprovince"
                                                        tabindex="42"
                                                        value="<?php echo array_key_exists('stateprovince', $occArr) ? $occArr['stateprovince'] : ''; ?>"
                                                        onchange="stateProvinceChanged(this.value)"
                                                        autocomplete="off"
                                                    />
                                                </div>
                                                <div id="countyDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        name="county"
                                                        tabindex="44"
                                                        value="<?php echo array_key_exists('county', $occArr) ? $occArr['county'] : ''; ?>"
                                                        onchange="fieldChanged('county');"
                                                        autocomplete="off"
                                                    />
                                                </div>
                                                <div id="municipalityDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('municipality')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        name="municipality"
                                                        tabindex="45"
                                                        value="<?php echo array_key_exists('municipality', $occArr) ? $occArr['municipality'] : ''; ?>"
                                                        onchange="fieldChanged('municipality');"
                                                        autocomplete="off"
                                                    />
                                                </div>
                                            </div>
                                            <div id="localityDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('locality')"
                                                ><img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                    /></a>
                                                ...
                                                <input
                                                    ...
                                                    name="locality"
                                                    tabindex="46"
                                                    value="<?php echo array_key_exists('locality', $occArr) ? $occArr['locality'] : ''; ?>"
                                                    onchange="fieldChanged('locality');"
                                                />
                                                <a
                                                    id="localityExtraToggle"
                                                    onclick="toggle('localityExtraDiv');"
                                                >
                                                    <img
                                                        src="../../images/editplus.png"
                                                        style="width:15px;"
                                            ...
                                            >
                                                <div id="locationRemarksDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        value="<?php echo array_key_exists('locationremarks', $occArr) ? $occArr['locationremarks'] : ''; ?>"
                                                        onchange="fieldChanged('locationremarks');"
                                                    />
                                                </div>
                                            </div>
                                            <?php
                                            ...
                                            <div id="localSecurityDiv">
                                                <div style="float:left;">
                                                    <input
                                                        ...
                                                        tabindex="0"
                                                        value="1" <?php echo $lsHasValue ? "CHECKED" : ""; ?>
                                                        onchange="localitySecurityChanged(this.form);"
                                                        title="Hide Locality Data from General Public"
                                                    />
                                                    <?php echo(defined('LOCALITYSECURITYLABEL') ? LOCALITYSECURITYLABEL : 'Locality Security'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('localitySecurity')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                ...
                                                <div
                                                    id="locsecreason"
                                                    style="margin-left:5px;border:2px solid gray;float:left;display:<?php echo($lsrValue ? 'inline' : 'none') ?>;padding:3px"
                                                >
                                                    <div><input
                                                            name="lockLocalitySecurity"
                                                            type="checkbox"
                                                            onchange="securityLockChanged(this)" <?php echo($lsrValue ? 'checked' : '') ?> />
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="0"
                                                        onchange="localitySecurityReasonChanged();"
                                                        value="<?php echo $lsrValue; ?>"
                                                        title="Entering any text will lock security status on or off; leave blank to accept default security status"
                                                    />
                                                </div>
                                            </div>
                                            <div style="clear:both;">
                                                <div id="decimalLatitudeDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="50"
                                                        maxlength="15"
                                                        value="<?php echo $latValue; ?>"
                                                        onchange="decimalLatitudeChanged(this.form)"
                                                    />
                                                </div>
                                                <div id="decimalLongitudeDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="52"
                                                        maxlength="15"
                                                        value="<?php echo $longValue; ?>"
                                                        onchange="decimalLongitudeChanged(this.form);"
                                                    />
                                                </div>
                                                <div
                                                    id="coordinateUncertaintyInMetersDiv"
                                                >
                                                    <?php echo(defined('COORDINATEUNCERTAINITYINMETERSLABEL') ? COORDINATEUNCERTAINITYINMETERSLABEL : 'Uncertainty'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('coordinateUncertaintyInMeters')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="54"
                                                        maxlength="10"
                                                        value="<?php echo array_key_exists('coordinateuncertaintyinmeters', $occArr) ? $occArr['coordinateuncertaintyinmeters'] : ''; ?>"
                                                        onchange="coordinateUncertaintyInMetersChanged(this.form);"
                                                        title="Uncertainty in Meters"
                                                    />
                                                </div>
                                                <div
                                                    id="googleDiv"
                                                    onclick="openMappingAid();"
                                                    title="Google Maps"
                                                >
                                                    <img
                                                ...
                                                <div
                                                    id="geoLocateDiv"
                                                    title="GeoLocate locality"
                                                >
                                                    <a
                                                        href="#"
                                                        onclick="geoLocateLocality();"
                                                    ><img
                                                            src="../../images/geolocate.png"
                                                        /></a>
                                                </div>
                                                <div
                                                    id="coordCloningDiv"
                                                    title="Coordinate cloning tool"
                                                >
                                                    <input
                                                        type="button"
                                                        value="C"
                                                        onclick="geoCloneTool()"
                                                    />
                                                </div>
                                                <div
                                                    id="geoToolsDiv"
                                                    title="Tools for converting additional formats"
                                                >
                                                    <input
                                                        type="button"
                                                        value="F"
                                                        onclick="toggleCoordDiv()"
                                                    />
                                                </div>
                                                <div id="geodeticDatumDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('geodeticDatum')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="56"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('geodeticdatum', $occArr) ? $occArr['geodeticdatum'] : ''; ?>"
                                                        onchange="fieldChanged('geodeticdatum');"
                                                    />
                                                </div>
                                                <div
                                                    id="verbatimCoordinatesDiv"
                                                >
                                                    <div
                                                        style="float:left;margin:18px 2px 0px 2px"
                                                        title="Recalculate Decimal Coordinates"
                                                    >
                                                        <a
                                                            href="#"
                                                            onclick="parseVerbatimCoordinates(document.fullform,1);return false"
                                                        >&lt;&lt;</a>
                                                    </div>
                                                    <div style="float:left;">
                                                        ...
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('verbatimCoordinates')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="57"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('verbatimcoordinates', $occArr) ? $occArr['verbatimcoordinates'] : ''; ?>"
                                                            onchange="verbatimCoordinatesChanged(this.form);"
                                                            title=""
                                                        />
                                                    </div>
                                                </div>
                                            ...
                                            <div style="clear:both;">
                                                <div id="elevationDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('minimumElevationInMeters')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="58"
                                                        maxlength="6"
                                                        value="<?php echo array_key_exists('minimumelevationinmeters', $occArr) ? $occArr['minimumelevationinmeters'] : ''; ?>"
                                                        onchange="minimumElevationInMetersChanged(this.form);"
                                                        title="Minumum Elevation In Meters"
                                                    />
                                                    -
                                                    <input
                                                        type="text"
                                                        ...
                                                        tabindex="60"
                                                        maxlength="6"
                                                        value="<?php echo array_key_exists('maximumelevationinmeters', $occArr) ? $occArr['maximumelevationinmeters'] : ''; ?>"
                                                        onchange="maximumElevationInMetersChanged(this.form);"
                                                ...
                                                <div id="verbatimElevationDiv">
                                                    <div
                                                        style="float:left;margin:18px 2px 0px 2px"
                                                        title="Recalculate Elevation in Meters"
                                                    >
                                                        <a
                                                            href="#"
                                                            onclick="parseVerbatimElevation(document.fullform);return false"
                                                        >&lt;&lt;</a>
                                                    </div>
                                                    <div style="float:left;">
                                                        ...
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('verbatimElevation')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="61"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('verbatimelevation', $occArr) ? $occArr['verbatimelevation'] : ''; ?>"
                                                            onchange="verbatimElevationChanged(this.form);"
                                                        />
                                                    </div>
                                                </div>
                                                <div id="depthDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('minimumDepthInMeters')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a>
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="63"
                                                        maxlength="6"
                                                        value="<?php echo array_key_exists('minimumdepthinmeters', $occArr) ? $occArr['minimumdepthinmeters'] : ''; ?>"
                                                        onchange="minimumDepthInMetersChanged(this.form);"
                                                        title="Minumum Depth In Meters"
                                                    />
                                                    -
                                                    <input
                                                        type="text"
                                                        ...
                                                        tabindex="64"
                                                        maxlength="6"
                                                        value="<?php echo array_key_exists('maximumdepthinmeters', $occArr) ? $occArr['maximumdepthinmeters'] : ''; ?>"
                                                        onchange="maximumDepthInMetersChanged(this.form);"
                                                ...
                                                <div id="verbatimDepthDiv">
                                                    <div style="float:left;">
                                                        ...
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('verbatimDepth')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="65"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('verbatimdepth', $occArr) ? $occArr['verbatimdepth'] : ''; ?>"
                                                            onchange="fieldChanged('verbatimdepth');"
                                                        />
                                                    </div>
                                                </div>
                                                <div
                                                    id="georefExtraToggleDiv"
                                                    onclick="toggle('georefExtraDiv');"
                                                >
                                                    <img
                                                        src="../../images/editplus.png"
                                                        style="width:15px;"
                                            ...
                                            <div
                                                id="georefExtraDiv"
                                                style="<?php echo $georefExtraDiv; ?>;"
                                            >
                                                <div style="clear:both;">
                                                    <div
                                                        id="georeferencedByDiv"
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="66"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('georeferencedby', $occArr) ? $occArr['georeferencedby'] : ''; ?>"
                                                            onchange="fieldChanged('georeferencedby');"
                                                        />
                                                    </div>
                                                    <div
                                                        id="georeferenceSourcesDiv"
                                                    >
                                                        <?php echo(defined('GEOREFERENCESOURCESLABEL') ? GEOREFERENCESOURCESLABEL : 'Georeference Sources'); ?>
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('georeferenceSources')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="70"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('georeferencesources', $occArr) ? $occArr['georeferencesources'] : ''; ?>"
                                                            onchange="fieldChanged('georeferencesources');"
                                                        />
                                                    </div>
                                                    <div
                                                        id="georeferenceRemarksDiv"
                                                    >
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="74"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('georeferenceremarks', $occArr) ? $occArr['georeferenceremarks'] : ''; ?>"
                                                            onchange="fieldChanged('georeferenceremarks');"
                                                        />
                                                    </div>
                                                </div>
                                                <div style="clear:both;">
                                                    <div
                                                        id="georeferenceProtocolDiv"
                                                    >
                                                        <?php echo(defined('GEOREFERENCEPROTOCOLLABEL') ? GEOREFERENCEPROTOCOLLABEL : 'Georeference Protocol'); ?>
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('georeferenceProtocol')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="76"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('georeferenceprotocol', $occArr) ? $occArr['georeferenceprotocol'] : ''; ?>"
                                                            onchange="fieldChanged('georeferenceprotocol');"
                                                        />
                                                    </div>
                                                    <div
                                                        id="georeferenceVerificationStatusDiv"
                                                    >
                                                        <?php echo(defined('GEOREFERENCEVERIFICATIONSTATUSLABEL') ? GEOREFERENCEVERIFICATIONSTATUSLABEL : 'Georef Verification Status'); ?>
                                                        <a
                                                            href="#"
                                                            onclick="return dwcDoc('georeferenceVerificationStatus')"
                                                        ><img
                                                                class="docimg"
                                                                src="../../images/qmark.png"
                                                            /></a>
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="78"
                                                            maxlength="32"
                                                            value="<?php echo array_key_exists('georeferenceverificationstatus', $occArr) ? $occArr['georeferenceverificationstatus'] : ''; ?>"
                                                            onchange="fieldChanged('georeferenceverificationstatus');"
                                                        />
                                                    </div>
                                                    <div id="footprintWktDiv">
                                                        ...
                                                        <textarea
                                                            name="footprintwkt"
                                                            id="footprintWKT"
                                                            onchange="footPrintWktChanged(this)"
                                                            style="height:40px;resize:vertical;"
                                                        ><?php echo array_key_exists('footprintwkt', $occArr) ? $occArr['footprintwkt'] : ''; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            ...
                                            <div id="habitatDiv">
                                                ...
                                                <input
                                                    ...
                                                    name="habitat"
                                                    tabindex="80"
                                                    value="<?php echo array_key_exists('habitat', $occArr) ? $occArr['habitat'] : ''; ?>"
                                                    onchange="fieldChanged('habitat');"
                                                />
                                            </div>
                                            <div id="substrateDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('substrate')"
                                                ><img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                    /></a>
                                                ...
                                                <input
                                                    ...
                                                    tabindex="82"
                                                    maxlength="500"
                                                    value="<?php echo array_key_exists('substrate', $occArr) ? $occArr['substrate'] : ''; ?>"
                                                    onchange="fieldChanged('substrate');"
                                                />
                                            </div>
                                            <?php
                                            if (isset($QuickHostEntryIsActive) && $QuickHostEntryIsActive) { // Quick host field
                                                ...
                                                ?>
                                                <div id="hostDiv">
                                                    <?php echo(defined('HOSTLABEL') ? HOSTLABEL : 'Host'); ?>
                                                    <br/>
                                                    <input
                                                        type="text"
                                                        name="host"
                                                        ...
                                                        tabindex="82"
                                                        maxlength="500"
                                                        value="<?php echo($quickHostArr ? $quickHostArr['verbatimsciname'] : ''); ?>"
                                                        onchange="fieldChanged('host');"
                                                    />
                                                    <input
                                                        type="hidden"
                                                        name="hostassocid"
                                                        value="<?php echo($quickHostArr ? $quickHostArr['associd'] : ''); ?>"
                                                    />
                                                </div>
                                                <?php
                                            }
                                            ...
                                            <div id="associatedTaxaDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('associatedTaxa')"
                                                ><img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                        style="width:9px;margin-bottom:2px"
                                                    /></a>
                                                <br/>
                                                <textarea
                                                    name="associatedtaxa"
                                                    tabindex="89"
                                                    onchange="fieldChanged('associatedtaxa');"
                                                ><?php echo array_key_exists('associatedtaxa', $occArr) ? $occArr['associatedtaxa'] : ''; ?></textarea>
                                                <?php
                                            ...
                                            <div id="verbatimAttributesDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('verbatimAttributes')"
                                                ><img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                    /></a>
                                                ...
                                                <input
                                                    type="text"
                                                    name="verbatimattributes"
                                                    tabindex="86"
                                                    value="<?php echo array_key_exists('verbatimattributes', $occArr) ? $occArr['verbatimattributes'] : ''; ?>"
                                                    onchange="fieldChanged('verbatimattributes');"
                                                />
                                            </div>
                                            <div id="occurrenceRemarksDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('occurrenceRemarks')"
                                                ><img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                        style="width:9px;margin-bottom:2px"
                                                ...
                                                <input
                                                    ...
                                                    tabindex="88"
                                                    value="<?php echo array_key_exists('occurrenceremarks', $occArr) ? $occArr['occurrenceremarks'] : ''; ?>"
                                                    onchange="fieldChanged('occurrenceremarks');"
                                            ...
                                            <div id="fieldNotesDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('fieldNotes')"
                                                ><img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                        style="width:9px;margin-bottom:2px"
                                                ...
                                                <textarea
                                                    name="fieldnotes"
                                                    tabindex="88.5"
                                                    onchange="fieldChanged('fieldnotes');"
                                                    title="Field Notes"
                                                ><?php echo array_key_exists('fieldnotes', $occArr) ? $occArr['fieldnotes'] : ''; ?></textarea>
                                            </div>
                                            ...
                                            <div id="dynamicPropertiesDiv">
                                                ...
                                                <a
                                                    href="#"
                                                    onclick="return dwcDoc('dynamicProperties')"
                                                >
                                                    <img
                                                        class="docimg"
                                                        src="../../images/qmark.png"
                                                ...
                                                <textarea
                                                    ...
                                                    tabindex="89"
                                                    onchange="fieldChanged('dynamicproperties');"
                                                    title="<?php echo(defined('DYNAMICPROPERTIESLABEL') ? DYNAMICPROPERTIESLABEL : 'Dynamic Properties'); ?>"
                                                ><?php echo array_key_exists('dynamicproperties', $occArr) ? $occArr['dynamicproperties'] : ''; ?></textarea>
                                                <a
                                                    href="#"
                                                    onclick="openDynPropsAid(); return false;"
                                                ><img
                                                        src="../../images/list.png"
                                                    /></a>
                                            </div>
                                            ...
                                            <div style="padding:2px;">
                                                <div id="lifeStageDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('lifeStage')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="90"
                                                        maxlength="45"
                                                        value="<?php echo array_key_exists('lifestage', $occArr) ? $occArr['lifestage'] : ''; ?>"
                                                        onchange="fieldChanged('lifestage');"
                                                    />
                                                </div>
                                                <div id="sexDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="92"
                                                        maxlength="45"
                                                        value="<?php echo array_key_exists('sex', $occArr) ? $occArr['sex'] : ''; ?>"
                                                        onchange="fieldChanged('sex');"
                                                    />
                                                </div>
                                                <div id="individualCountDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('individualCount')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="94"
                                                        maxlength="45"
                                                        value="<?php echo array_key_exists('individualcount', $occArr) ? $occArr['individualcount'] : ''; ?>"
                                                        onchange="fieldChanged('individualcount');"
                                                    />
                                                </div>
                                                <div id="samplingProtocolDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('samplingProtocol')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="95"
                                                        maxlength="100"
                                                        value="<?php echo array_key_exists('samplingprotocol', $occArr) ? $occArr['samplingprotocol'] : ''; ?>"
                                                        onchange="fieldChanged('samplingprotocol');"
                                                    />
                                                </div>
                                                <div id="preparationsDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('preparations')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="97"
                                                        maxlength="100"
                                                        value="<?php echo array_key_exists('preparations', $occArr) ? $occArr['preparations'] : ''; ?>"
                                                        onchange="fieldChanged('preparations');"
                                                    />
                                                </div>
                                                <div
                                                    id="reproductiveConditionDiv"
                                                >
                                                    <?php echo(defined('REPRODUCTIVECONDITIONLABEL') ? REPRODUCTIVECONDITIONLABEL : 'Phenology'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('reproductiveCondition')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    ...
                                                    if (isset($reproductiveConditionTerms)) {
                                                        if ($reproductiveConditionTerms) {
                                                            ...
                                                            <select
                                                                ...
                                                                onchange="fieldChanged('reproductivecondition');"
                                                                tabindex="99"
                                                            >
                                                                <option
                                                                    value=""
                                                        ...
                                                        <input
                                                            ...
                                                            tabindex="99"
                                                            maxlength="255"
                                                            value="<?php echo array_key_exists('reproductivecondition', $occArr) ? $occArr['reproductivecondition'] : ''; ?>"
                                                            onchange="fieldChanged('reproductivecondition');"
                                                        />
                                                        <?php
                                                    }
                                                ...
                                                <div id="establishmentMeansDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('establishmentMeans')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="100"
                                                        maxlength="32"
                                                        value="<?php echo array_key_exists('establishmentmeans', $occArr) ? $occArr['establishmentmeans'] : ''; ?>"
                                                        onchange="fieldChanged('establishmentmeans');"
                                                    />
                                                </div>
                                                <div id="cultivationStatusDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="102"
                                                        value="1" <?php echo $hasValue ? 'CHECKED' : ''; ?>
                                                        onchange="fieldChanged('cultivationstatus');"
                                                    />
                                        ...
                                        <fieldset>
                                            ...
                                            >
                                                <div id="typeStatusDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="103"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('typestatus', $occArr) ? $occArr['typestatus'] : ''; ?>"
                                                        onchange="fieldChanged('typestatus');"
                                                    />
                                                </div>
                                                <div id="dispositionDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('disposition')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="104"
                                                        maxlength="32"
                                                        value="<?php echo array_key_exists('disposition', $occArr) ? $occArr['disposition'] : ''; ?>"
                                                        onchange="fieldChanged('disposition');"
                                                    />
                                                </div>
                                                <div
                                                    id="occurrenceIdDiv"
                                                    title="If different than institution code"
                                                >
                                                    <?php echo(defined('OCCURRENCEIDLABEL') ? OCCURRENCEIDLABEL : 'Occurrence ID'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('occurrenceid')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="105"
                                                        maxlength="255"
                                                        value="<?php echo array_key_exists('occurrenceid', $occArr) ? $occArr['occurrenceid'] : ''; ?>"
                                                        onchange="fieldChanged('occurrenceid');"
                                                    />
                                                </div>
                                                <div
                                                    id="fieldNumberDiv"
                                                ...
                                                >
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('fieldnumber')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="107"
                                                        maxlength="45"
                                                        value="<?php echo array_key_exists('fieldnumber', $occArr) ? $occArr['fieldnumber'] : ''; ?>"
                                                        onchange="fieldChanged('fieldnumber');"
                                                    />
                                                </div>
                                                <div id="basisOfRecordDiv">
                                                    ...
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('basisOfRecord')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    ...
                                                    <select
                                                        name="basisofrecord"
                                                        tabindex="109"
                                                        onchange="fieldChanged('basisofrecord');"
                                                    >
                                                        <?php
                                                ...
                                                <div id="languageDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="111"
                                                        maxlength="20"
                                                        value="<?php echo array_key_exists('language', $occArr) ? $occArr['language'] : ''; ?>"
                                                        onchange="fieldChanged('language');"
                                                    />
                                                </div>
                                                <div id="labelProjectDiv">
                                                    ...
                                                    <input
                                                        ...
                                                        tabindex="112"
                                                        maxlength="45"
                                                        value="<?php echo array_key_exists('labelproject', $occArr) ? $occArr['labelproject'] : ''; ?>"
                                                        onchange="fieldChanged('labelproject');"
                                                    />
                                                </div>
                                                <div
                                                    id="duplicateQuantityDiv"
                                                    title="aka label quantity"
                                                >
                                                    <?php echo(defined('DUPLICATEQUALITYCOUNTLABEL') ? DUPLICATEQUALITYCOUNTLABEL : 'Dupe Count'); ?>
                                                    <br/>
                                                    <input
                                                        type="text"
                                                        name="duplicatequantity"
                                                        tabindex="116"
                                                        value="<?php echo array_key_exists('duplicatequantity', $occArr) ? $occArr['duplicatequantity'] : ''; ?>"
                                                        onchange="fieldChanged('duplicatequantity');"
                                                    />
                                                </div>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <div
                                                    id="institutionCodeDiv"
                                                    title="Overrides institution code set within collection's metadata form"
                                                >
                                                    <?php echo(defined('INSTITUTIONCODELABEL') ? INSTITUTIONCODELABEL : 'Institution Code (override)'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('institutionCode')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="116"
                                                        maxlength="32"
                                                        value="<?php echo array_key_exists('institutioncode', $occArr) ? $occArr['institutioncode'] : ''; ?>"
                                                        onchange="fieldChanged('institutioncode');"
                                                    />
                                                </div>
                                                <div
                                                    id="collectionCodeDiv"
                                                    title="Overrides collection code set within collection's metadata form"
                                                >
                                                    <?php echo(defined('COLLECTIONCODELABEL') ? COLLECTIONCODELABEL : 'Collection Code (override)'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('collectionCode')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="117"
                                                        maxlength="32"
                                                        value="<?php echo array_key_exists('collectioncode', $occArr) ? $occArr['collectioncode'] : ''; ?>"
                                                        onchange="fieldChanged('collectioncode');"
                                                    />
                                                </div>
                                                <div
                                                    id="ownerInstitutionCodeDiv"
                                                    title="If different than institution code"
                                                >
                                                    <?php echo(defined('OWNERINSTITUTIONCODELABEL') ? OWNERINSTITUTIONCODELABEL : 'Owner Code (override)'); ?>
                                                    <a
                                                        href="#"
                                                        onclick="return dwcDoc('ownerInstitutionCode')"
                                                    ><img
                                                            class="docimg"
                                                            src="../../images/qmark.png"
                                                        /></a><br/>
                                                    <input
                                                        ...
                                                        tabindex="118"
                                                        maxlength="32"
                                                        value="<?php echo array_key_exists('ownerinstitutioncode', $occArr) ? $occArr['ownerinstitutioncode'] : ''; ?>"
                                                        onchange="fieldChanged('ownerinstitutioncode');"
                                                    />
                                                </div>
                                                <div id="processingStatusDiv">
                                                    ...
                                                    <select
                                                        ...
                                                        tabindex="120"
                                                        onchange="fieldChanged('processingstatus');"
                                                    >
                                                        <option value=''>No Set
                                                            Status
                                                        </option>
                                                ...
                                                <div
                                                    id="dataGeneralizationsDiv"
                                                    title="aka data generalizations"
                                                >
                                                    <?php echo(defined('DATAGENERALIZATIONSLABEL') ? DATAGENERALIZATIONSLABEL : 'Data Generalizations'); ?>
                                                    <br/>
                                                    <input
                                                        type="text"
                                                        name="datageneralizations"
                                                        tabindex="121"
                                                        value="<?php echo array_key_exists('datageneralizations', $occArr) ? $occArr['datageneralizations'] : ''; ?>"
                                                        onchange="fieldChanged('datageneralizations');"
                                                    />
                                                </div>
                                            </div>
                                            <?php
                                            if ($occId) {
                                                ...
                                                <div id="pkDiv">
                                                    ...
                                                    <div
                                                        style="float:left;"
                                                        title="Internal occurrence record Primary Key (occid)"
                                                    >
                                        ...
                                        <div style="padding:10px;">
                                            <input
                                                type="hidden" name="occid"
                                                value="<?php echo $occId; ?>"
                                            />
                                            <input
                                                type="hidden" name="collid"
                                                value="<?php echo $collId; ?>"
                                            />
                                            <input
                                                type="hidden"
                                                name="observeruid"
                                                value="<?php echo $SYMB_UID; ?>"
                                            />
                                            <input
                                                type="hidden" name="csmode"
                                                value="<?php echo $crowdSourceMode; ?>"
                                            />
                                            <input
                                                type="hidden" name="linkdupe"
                                                value=""
                                            />
                                            <?php
                                            if ($occId) {
                                                if (($isEditor == 1 || $isEditor == 2) && !$crowdSourceMode) {
                                                    ...
                                                    <div style="float:right;">
                                                        <fieldset
                                                            style="padding:15px;background-color:lightyellow;"
                                                        >
                                                            <legend><b>Additional
                                                                    Options</b>
                                                            </legend>
                                                            <input
                                                                type="button"
                                                                value="Go to New Occurrence Record"
                                                                onclick="verifyGotoNew(this.form);"
                                                            /><br/>
                                                            <input
                                                                type="hidden"
                                                                name="gotomode"
                                                ...
                                                <div id="editButtonDiv">
                                                    <input
                                                        ...
                                                        value="Save Edits"
                                                        style="width:150px;"
                                                        onclick="return verifyFullFormEdits(this.form)"
                                                        disabled
                                                    />
                                                    <br/>
                                                    Status Auto-Set:
                                                    <select
                                                        ...
                                                        onchange="autoProcessingStatusChanged(this)"
                                                    >
                                                        <option value=''>Not
                                                            Activated
                                                        </option>
                                                ...
                                                <div id="addButtonDiv">
                                                    <input
                                                        ...
                                                        value="<?php echo $paramsArr['un']; ?>"
                                                    />
                                                    <input
                                                        type="button"
                                                        name="submitaddbutton"
                                                        value="Add Record"
                                                        onclick="this.disabled=true;this.form.submit();"
                                                        style="width:150px;font-weight:bold;margin:10px;"
                                                    />
                                                    <input
                                                        type="hidden"
                                                        name="submitaction"
                                                    ...
                                                    >
                                                        <input
                                                            type="radio"
                                                            name="gotomode"
                                                            value="1" <?php echo($goToMode == 1 ? 'CHECKED' : ''); ?> />
                                                        Go to New Record<br/>
                                                        <input
                                                            type="radio"
                                                            name="gotomode"
                                                            value="2" <?php echo($goToMode == 2 ? 'CHECKED' : ''); ?> />
                                                        Go to New Record and
                                                        Carryover Locality
                                                        Information<br/>
                                                        <input
                                                            type="radio"
                                                            name="gotomode"
                                                            value="0" <?php echo(!$goToMode ? 'CHECKED' : ''); ?> />
                                                        Remain on Editing Page
                                                        (add images,
                                                        determinations, etc)
                                                    </div>
                                                </div>
                        ...
                        <td
                            id="imgtd" style="display:none;width:430px;"
                            valign="top"
                        >
                            <?php
