...
?>
<div id='innertext'
     style='width:95%;min-height:400px;clear:both;background-color:white;'>
                ...
                <legend><b>New Voucher Assignment</b></legend>
                  ...
                  if ($tid) {
                    ...
                    <div style='margin:10px;'>
                      <form action="../../checklists/clsppeditor.php"
                            method="post"
                            onsubmit="return verifyVoucherForm(this);">
                        <div>
                          Add as voucher to checklist:
                          <input name='voccid' type='hidden'
                        ...
                        <div style='margin:5px 0px 0px 10px;'>
                          Notes:
                          <input name='vnotes' type='text' size='50'
                                 title='Viewable to public'>
                        </div>
                        <div style='margin:5px 0px 0px 10px;'>
                          Editor Notes:
                          <input name='veditnotes' type='text' size='50'
                                 title='Viewable only to checklist editors'>
                        </div>
                        <div>
                    ...
                    <div style='margin:20px;'>
                      ...
                      scientific name counld not be verified in the taxonomic
                      thesaurus (misspelled?)
                    </div>
                      <?php
                  }
                  ?>
      ...
      <fieldset style="padding:20px;margin:15px;">
        ...
        <fieldset style='padding:15px;margin-top:30px;'>
          ...
          <form action="index.php" method="post"
                onsubmit="return verifyDatasetForm(this);">
            <div style="margin:3px">
              ...
              <input name="dsname" type="text" value="" maxlength="100"
                     style="width:200px;"/>
            </div>
            <div style="margin:5px">
              <b>Notes:</b><br/>
              <input name="notes" type="text" value="" maxlength="250"
                     style="width:90%;"/>
            </div>
            <div style="margin:15px">
              <input name="occid" type="hidden" value="<?php echo $occid; ?>"/>
              <input name="collid" type="hidden"
  ...
  <div id="associatedOccurrencesDiv" style="margin:15px;">
      ...
      $currentOccs = array_map(function ($ao) {
          return OccurrenceUtilities::findAndCreateLinks($ao);
      }, $currentOccs);
